                                        ...
                                        <a href="!#" key={idx}  onClick={(e)=>onClickViewProduct(e, item, './images/index/')}>
                                            ...
                                            <div className="product-txt-box">
                                                ...
                                                <div className="price-box">
                                                    <span className={`price${item.할인율 === 0 ? ' on' : ''}`}>{Math.round(item.정가 * (1 - item.할인율)).toLocaleString('ko-KR')}원</span>
                                                    ...
                                                    {                                            
                                                        item.할인율 !== 0 &&
                                                        <strong className='cost'>{item.정가.toLocaleString('ko-KR')}원</strong>
                                                    }                                         
                                                </div>
